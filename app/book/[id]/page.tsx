  ...
  return (
    <div className="min-h-screen bg-[#FDFDFD]">
      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        <Link href="/" className="inline-flex items-center text-gray-500 hover:text-indigo-600 mb-6 font-medium transition-colors">
        ...
        <div className="bg-white rounded-3xl shadow-lg border border-gray-100 overflow-hidden md:flex">
          ...
          <div className="md:w-1/3 bg-gray-50 p-8 flex items-center justify-center">
            <div className="relative w-48 aspect-[2/3] shadow-2xl rounded-lg overflow-hidden rotate-2 hover:rotate-0 transition-transform duration-500">
               {book.cover_url ? (
                 ...
                 <div className="w-full h-full bg-gray-200 flex items-center justify-center text-gray-400">No Cover</div>
               )}
            </div>
          </div>
          ...
          <div className="md:w-2/3 p-8 md:p-10">
            <h1 className="text-xl font-extrabold text-gray-900 mb-2">{book.title}</h1>
            <p className="text-l text-gray-500 mb-6 font-medium">โดย {book.author || '-'}</p>
